...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/sit/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-sit',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-sit')
    if(!url){
      this.save()
    }
  }
...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/zip/sit/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-zip-sit',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-zip-sit')
    if(!url){
      this.save()
    }
  }
