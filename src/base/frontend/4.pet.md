...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/pet/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-pet',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-pet')
    if(!url){
      this.save()
    }
  }
...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/zip/pet/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-zip-pet',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-zip-pet')
    if(!url){
      this.save()
    }
  }
