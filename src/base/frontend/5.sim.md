...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/sim/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-sim',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-sim')
    if(!url){
      this.save()
    }
  }
...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/zip/sim/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-zip-sim',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-zip-sim')
    if(!url){
      this.save()
    }
  }
