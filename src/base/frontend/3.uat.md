...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/uat/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-uat',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-uat')
    if(!url){
      this.save()
    }
  }
...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/zip/uat/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-zip-uat',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-zip-uat')
    if(!url){
      this.save()
    }
  }
