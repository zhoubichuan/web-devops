...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/pord/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-prod',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-prod')
    if(!url){
      this.save()
    }
  }
...
export default {
  data() {
    return {
      url:'/usr/src/zhoubichuan/zip/prod/'
    }
  },
  methods: {
    async save() {
      localStorage.setItem('web-devops-frontend-zip-prod',this.url)
    },
  },
  mounted() {
    const url = localStorage.getItem('web-devops-frontend-zip-prod')
    if(!url){
      this.save()
    }
  }
